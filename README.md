...
**[Download v0.4.0 for macOS (.dmg)](https://github.com/ysrdevs/goldeneye-metal/releases/download/v0.4.0/GoldenEye-Metal-0.4.0-macos-arm64.dmg)** ·
[Release notes](https://github.com/ysrdevs/goldeneye-metal/releases/tag/v0.4.0) ·
...
1. [Download the DMG](https://github.com/ysrdevs/goldeneye-metal/releases/download/v0.4.0/GoldenEye-Metal-0.4.0-macos-arm64.dmg).
...
| Platform | Status |
| --- | --- |
| Apple Silicon macOS | Active development; v0.4.0 reaches first-mission gameplay |
